(function () {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    // 1. Add your CSS to the page with an onload event
    const cssLink = document.createElement("link");
    cssLink.rel = "stylesheet";
    cssLink.href =
      "https://cdn.jsdelivr.net/gh/81-Shop-Projects/tacomama@main/styles.css";
    cssLink.onload = function () {
      // 4. Add your custom HTML content (e.g., cookie consent banner) only after CSS loads.
      // The cookie-consent container starts with opacity 0 and a transition.
      const cookieConsentHTML = `
        <div class="cookie-consent" style="opacity: 0; transition: opacity 0.5s ease-in-out;">
          <!-- Banner -->
      ...
      // Initialize custom JavaScript logic after HTML is inserted
    ...
    gtmScript.innerHTML = `
            ...
            })(window,document,'script','dataLayer','GTM-WJKQZ9V8');
          `;
    ...
    gtmNoscript.innerHTML = `
            <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WJKQZ9V8"
    ...
    // Note:
    // Initialization (showBannerIfFirstVisit, initializeConsentMode, addEventListeners)
    // now occurs after the CSS has loaded and the HTML has been injected.
  });
})();
